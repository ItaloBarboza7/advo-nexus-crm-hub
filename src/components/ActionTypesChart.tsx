              ...
              <div key={item.type} className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600 ml-4">
                    ...
                    <span className="text-xs bg-gradient-to-r from-blue-50 to-blue-100 px-3 py-1 rounded-full font-semibold min-w-[3.5rem] text-center border border-blue-200 text-blue-700 shadow-sm">
